        ...
        <div class="col-xl-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <input type="text" class="form-control mb-2" id="comment-writer" placeholder="작성자">
...
<dialog id="write-modal">
    <form id="write-form">
        ...
        <textarea name="content" class="form-control mb-2" rows="5" placeholder="내용" required></textarea>
        <input type="text" name="writer" class="form-control mb-2" placeholder="작성자 (생략 시 익명)">
